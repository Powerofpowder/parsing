...
import time
import json
Для начала нужно получить token для доступа к api

Нужные параметры: марка - BMW, область: Москва
...
Смотрим на количество полученных машин

len(cars)
Приводим в порядок признаки: извлекаем только те, что нужны и переименовываем
